...
from utils.dataloader_BBBC003 import UnetDataset, unet_dataset_collate
...
1、该数据集是我根据网上找到的医药数据集特殊建立的训练文件，只是一个例子，用于展示数据集不是voc格式时要如何进行训练。
   ...
   b、有标签的医药数据集：
      ...
      因此数据集的标签需要改成，背景的像素点值为0，目标的像素点值为1。(在dataloader中修改)
...
if __name__ == "__main__":
    ...
    #------------------------------------------------------------------#
    save_dir            = 'logs_BBBC003_2'
    
    #------------------------------#
    #   数据集路径
    #------------------------------#
    VOCdevkit_path  = 'BBBC003'
    #------------------------------------------------------------------#
    #   建议选项：
    #   种类少（几类）时，设置为True
